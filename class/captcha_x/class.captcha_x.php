...
//       session_start ();
     ...
     * @return void
     */
    public function _add_dust_and_scratches($color)
    {
        extract($this->INI);
     ...
     * $return resource
     */
    public function _create_img_base()
    {
        extract($this->INI);
     ...
     * @return array
     */
    public function _get_random_letters()
    {
        extract($this->INI);
     ...
     * @return void
     */
    public function _print_letters()
    {
        extract($this->INI);
     ...
     * @return void
     */
    public function _put_md5_into_session()
    {
        extract($this->INI);
