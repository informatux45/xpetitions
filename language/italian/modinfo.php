...
define('_MI_XPETITIONS_MENU2', 'Petizioni');
define('_MI_XPETITIONS_MENU3', 'Circa');
define('_MI_XPETITIONS_MENU4', 'Firme');
define('_MI_XPETITIONS_MENU5', 'Mail');
define('_MI_XPETITIONS_MENU6', 'Campi');
...
define('_MI_XPETITIONS_NAVIGATION_HOME', 'Collegamento barra di navigazione homepage');
define('_MI_XPETITIONS_NAVIGATION_HOME_DSC', 'Questa opzione consente di visualizzare il link sulla home page del tuo sito web');
define('_MI_XPETITIONS_SHOW_HOME', 'Risultati petizioni alla homepage');
define('_MI_XPETITIONS_SHOW_HOME_DSC', 'Questa opzione consente di visualizzare petizioni online o colonna (attivi e archiviati)');
define('_MI_XPETITIONS_SHOW_HOME_LINE', 'Online');
define('_MI_XPETITIONS_SHOW_HOME_COL', 'Colonna');
