...
define("_AM_XPETITIONS_PETITION",		"Petizioni");
...
define("_AM_XPETITIONS_PETITION_CREATE",	"<span class='xpetitions_summary_create'>%s</span> petizione esistente");
define("_AM_XPETITIONS_PETITIONS_CREATE",	"<span class='xpetitions_summary_create'>%s</span> petizioni esistenti");
define("_AM_XPETITIONS_PETITION_ONLINE",	"<span class='xpetitions_summary_online'>%s</span> petizione attive");
define("_AM_XPETITIONS_PETITIONS_ONLINE",	"<span class='xpetitions_summary_online'>%s</span> petizioni attive");
define("_AM_XPETITIONS_PETITION_OFFLINE",	"<span class='xpetitions_summary_offline'>%s</span> petizione offline");
define("_AM_XPETITIONS_PETITIONS_OFFLINE",	"<span class='xpetitions_summary_offline'>%s</span> petizioni Offline");
define("_AM_XPETITIONS_PETITION_ARCHIVE",	"<span class='xpetitions_summary_archive'>%s</span> petizione archiviate");
...
define("_AM_XPETITIONS_CHECK1",			"Directory per l'upload dei file : %s");
